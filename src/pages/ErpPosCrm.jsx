...
const ErpPosCrm = () => {
  ...
  return (
    <div className="relative w-full">
      <SEO 
        title="ERP, POS & CRM Software Development in Bhubaneswar | Orbit Softworks" 
        description="Orbit Softworks builds powerful enterprise resource planning (ERP), point of sale (POS) billing systems, and CRM software for manufacturers and retail."
      />
      {/* Hero Section */}
        ...
        <HeroEntranceStagger className="relative z-10 text-center max-w-4xl px-4">
          <HeroItem>
            <h1 className="text-on-surface leading-tight mb-6" style={{ fontFamily: 'Sora, sans-serif', fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 800 }}>
              Enterprise <span className="text-secondary">ERP, CRM & POS</span>
            </h1>
          </HeroItem>
          <HeroItem>
            <p className="text-on-surface-variant max-w-2xl mx-auto text-lg mb-8">
              Unify your business operations with our comprehensive ERPs, high-speed POS billing systems, and intelligent CRM solutions tailored for Bhubaneswar's market.
            </p>
          </HeroItem>
        </HeroEntranceStagger>
      </section>
      ...
      <section ref={addRevealRef} className="reveal-on-scroll py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="glass-card p-12 rounded-[2rem] bg-surface-container">
           ...
           <p className="text-on-surface-variant mb-6 text-lg">
             Stop relying on disjointed spreadsheets. We provide centralized solutions that handle everything from production tracking and inventory to customer follow-ups and invoicing.
           </p>
           <ul className="space-y-4 mb-8">
             <li className="flex items-center gap-3 text-on-surface-variant">
               <span className="material-symbols-outlined text-secondary">check_circle</span>
               <span>Modular ERPs for Manufacturing & Wholesale</span>
             </li>
             <li className="flex items-center gap-3 text-on-surface-variant">
               <span className="material-symbols-outlined text-secondary">check_circle</span>
               <span>POS & Billing Systems with GST integration</span>
             </li>
             <li className="flex items-center gap-3 text-on-surface-variant">
               <span className="material-symbols-outlined text-secondary">check_circle</span>
               <span>CRM Systems for Lead & Sales Management</span>
             </li>
           </ul>
           <Link to="/contact">
